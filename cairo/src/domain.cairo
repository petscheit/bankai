...
namespace Domain {
    ...
    func get_domain{range_check_ptr}(slot: felt) -> Uint256 {
        ...
        if (fork == 0) {
            ...
            return (
                Uint256(
                    low=0x5f699a49ccd9b3fd666c35d4ae5f79e, high=0x7000000a8fee8ee9978418b64f1140b
                )
            );
        }
        ...
        if (fork == 1) {
            ...
            return (
                Uint256(
                    low=0xd45d10c47a506110d536465a1b29c3fe, high=0x700000060725ca1ffa72cacd1eedcf7
                )
            );
        }
        ...
        if (fork == 2) {
            ...
            return (
                Uint256(
                    low=0x10839ea6dcaaaa6372e95478610d7e08, high=0x700000036fa50131482fe2af396daf2
                )
            );
        }
        ...
        if (fork == 3) {
            ...
            return (
                Uint256(
                    low=0x60f0a2ed78c1a85f0654941a0d19d0fa, high=0x700000047eb72b3be36f08feffcaba7
                )
            );
        }
        return (
            Uint256(low=0x55fcf34b7e308f8fbca8e663bf565808, high=0x7000000d31f6191ca65c836e170318c)
        );
    }
