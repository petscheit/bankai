...
impl CustomHintProcessor {
    ...
    fn hints() -> HashMap<String, HintImpl> {
        ...
        hints.insert(circuits::HINT_RUN_EXTENSION_FIELD_MODULO_CIRCUIT.into(), circuits::run_extension_field_modulo_circuit);
        ...
        hints.insert(basic_field_ops::HINT_ASSERT_NOT_ZERO_MOD_P.into(), basic_field_ops::hint_assert_not_zero_mod_p);
        hints.insert(utils::HINT_WRITE_FELTS_TO_VALUE_SEGMENT_1.into(), utils::hint_write_felts_to_value_segment_1);
        hints.insert(utils::HINT_WRITE_FELTS_TO_VALUE_SEGMENT_2.into(), utils::hint_write_felts_to_value_segment_2);
        hints.insert(utils::HINT_WRITE_FELTS_TO_VALUE_SEGMENT_3.into(), utils::hint_write_felts_to_value_segment_3);
        hints.insert(utils::HINT_HASH_FULL_TRANSCRIPT_AND_GET_Z_4_LIMBS_1.into(), utils::hint_hash_full_transcript_and_get_z_4_limbs_1);
        hints.insert(utils::HINT_HASH_FULL_TRANSCRIPT_AND_GET_Z_4_LIMBS_2.into(), utils::hint_hash_full_transcript_and_get_z_4_limbs_2);
