CREATE SCHEMA IF NOT EXISTS bankai;

CREATE TABLE bankai.jobs (
...
CREATE TABLE bankai.epoch_merkle_paths (
...
CREATE TABLE bankai.verified_epoch (
    ...
    committee_hash TEXT NOT NULL, -- Sync committee hash of the sync committee related to this epoch
...
CREATE TABLE bankai.verified_sync_committee (
...
CREATE TABLE bankai.daemon_state (
