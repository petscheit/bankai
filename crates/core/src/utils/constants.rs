...
pub const MAX_CONCURRENT_PIE_GENERATIONS: usize = 2; // Define how many concurrent trace (pie file) generation jobs are allowed to not exhaust resources
pub const MAX_CONCURRENT_RPC_DATA_FETCH_JOBS: usize = 2; // Define how many data fetching jobs can be performed concurrently to not overload RPC
...
pub const STARKNET_TX_CONFIRMATION_CHECK_DELAY: u64 = 10; // In seconds
